  ...
  return (
    <Page title="FAQ">
      <div className="text-blob">
        ...
        <p>Security is important. Don&#39;t upload your files to services you don&#39;t trust.</p>
        <p>Your files never leave your browser. All computation is done in your browser. No data about your file is stored anywhere at any time.</p>
        <p>You can confirm this by opening the developer tools in your browser, going to the network section and uploading a test file. You will see no transfer of any private data to any service.</p>
        <p>MAXIF does some basic usage tracking to determine page views and usage statistics. This data is anonymous and does not use or create cookies.</p>
        ...
        <p>MAXIF has an extensive list of file signatures that it compares against when you upload a file. It will find the best fit and show the details.</p>
